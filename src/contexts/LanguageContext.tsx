...
export const translations: Translations = {
  ...
  processSteps: { ru: 'Шаги процесса', en: 'Process steps', uk: 'Кроки процесу' },
  processStepsHint: { ru: 'Создайте последовательность шагов: задачи, согласования, условия и автодействия. Соедините блоки линиями.', en: 'Build a sequence of steps: tasks, approvals, conditions and auto-actions. Connect blocks with lines.', uk: 'Створіть послідовність кроків: задачі, погодження, умови та автодії. Зʼєднайте блоки лініями.' },
  addBlock: { ru: 'Добавить блок', en: 'Add block', uk: 'Додати блок' },
  assignee: { ru: 'Исполнитель', en: 'Assignee', uk: 'Виконавець' },
  initiator: { ru: 'Инициатор запуска', en: 'Run initiator', uk: 'Ініціатор запуску' },
  hours: { ru: 'часов', en: 'hours', uk: 'годин' },
  conditionExpression: { ru: 'Условие (напр. amount > 50000)', en: 'Condition (e.g. amount > 50000)', uk: 'Умова (напр. amount > 50000)' },
  actionType: { ru: 'Тип действия', en: 'Action type', uk: 'Тип дії' },
  sendNotification: { ru: 'Отправить уведомление', en: 'Send notification', uk: 'Надіслати сповіщення' },
  createTaskAction: { ru: 'Создать задачу', en: 'Create task', uk: 'Створити задачу' },
  sendEmail: { ru: 'Отправить email', en: 'Send email', uk: 'Надіслати email' },
  approve: { ru: 'Согласовать', en: 'Approve', uk: 'Погодити' },
  ...
  stepStatus_approved: { ru: 'Согласовано', en: 'Approved', uk: 'Погоджено' },
  stepStatus_rejected: { ru: 'Отклонено', en: 'Rejected', uk: 'Відхилено' },
  stepStatus_returned: { ru: 'На доработке', en: 'Returned', uk: 'На доопрацюванні' },
  stepStatus_completed: { ru: 'Завершено', en: 'Completed', uk: 'Завершено' },
  searchRuns: { ru: 'Поиск запусков...', en: 'Search runs...', uk: 'Пошук запусків...' },
  allStatuses: { ru: 'Все статусы', en: 'All statuses', uk: 'Всі статуси' },
  allTypes: { ru: 'Все типы', en: 'All types', uk: 'Всі типи' },
  allInitiators: { ru: 'Все инициаторы', en: 'All initiators', uk: 'Всі ініціатори' },
  allAssignees: { ru: 'Все исполнители', en: 'All assignees', uk: 'Всі виконавці' },
  noRunsFound: { ru: 'Запусков не найдено', en: 'No runs found', uk: 'Запусків не знайдено' },
  by: { ru: 'от', en: 'by', uk: 'від' },
  color: { ru: 'Цвет', en: 'Color', uk: 'Колір' },
  name: { ru: 'Название', en: 'Name', uk: 'Назва' },
  ...
  processStep1Hint: { ru: 'Шаг 1 из 2 — основные данные процесса', en: 'Step 1 of 2 — basic process data', uk: 'Крок 1 з 2 — основні дані процесу' },
  processStep2Hint: { ru: 'Шаг 2 из 2 — схема выполнения', en: 'Step 2 of 2 — execution scheme', uk: 'Крок 2 з 2 — схема виконання' },
  basicData: { ru: 'Основные данные', en: 'Basic data', uk: 'Основні дані' },
  processScheme: { ru: 'Схема процесса', en: 'Process scheme', uk: 'Схема процесу' },
  customFieldsHint: { ru: 'Данные, которые нужно заполнить при запуске процесса (напр. сумма, контрагент, комментарий).', en: 'Data to fill in when starting the process (e.g. amount, counterparty, comment).', uk: 'Дані, які потрібно заповнити при запуску процесу (напр. сума, контрагент, коментар).' },
  howBuilderWorks: { ru: 'Как работает конструктор', en: 'How the builder works', uk: 'Як працює конструктор' },
  builderHelp: { ru: 'Добавьте шаги из левой панели и соедините их линиями (перетащите от правого кружка блока к левому кружку следующего). Кликните по блоку — справа появятся его настройки: описание задачи, требования, ожидаемый результат, исполнитель и срок выполнения.', en: 'Add steps from the left panel and connect them with lines (drag from the right circle of a block to the left circle of the next). Click a block to open its settings on the right: task description, requirements, expected result, assignee and deadline.', uk: 'Додайте кроки з лівої панелі та зʼєднайте їх лініями (перетягніть від правого кружка блока до лівого кружка наступного). Клікніть по блоку — праворуч зʼявляться його налаштування: опис завдання, вимоги, очікуваний результат, виконавець і термін виконання.' },
  ...
  // Process categories & templates
  categories: { ru: 'Категории', en: 'Categories', uk: 'Категорії' },
  category: { ru: 'Категория', en: 'Category', uk: 'Категорія' },
  selectCategory: { ru: 'Выберите категорию', en: 'Select category', uk: 'Оберіть категорію' },
  uncategorized: { ru: 'Без категории', en: 'Uncategorized', uk: 'Без категорії' },
  addCategory: { ru: 'Добавить категорию', en: 'Add category', uk: 'Додати категорію' },
  categoryName: { ru: 'Название категории', en: 'Category name', uk: 'Назва категорії' },
  deleteCategoryConfirm: { ru: 'Категория будет удалена. Процессы останутся без категории.', en: 'Category will be deleted. Processes will remain uncategorized.', uk: 'Категорію буде видалено. Процеси залишаться без категорії.' },
  ...
  processTemplatesDescription: { ru: 'Выберите готовый шаблон, чтобы быстро создать процесс с набором полей.', en: 'Choose a template to quickly create a process with a set of fields.', uk: 'Оберіть готовий шаблон, щоб швидко створити процес із набором полів.' },
  createFromTemplate: { ru: 'Из шаблона', en: 'From template', uk: 'З шаблону' },
  browseTemplates: { ru: 'Посмотреть шаблоны', en: 'Browse templates', uk: 'Переглянути шаблони' },
  openTemplatesLibrary: { ru: 'Открыть библиотеку шаблонов', en: 'Open templates library', uk: 'Відкрити бібліотеку шаблонів' },
  ...
  backToProjects: { ru: 'Назад к проектам', en: 'Back to projects', uk: 'Назад до проектів' },
  projectNotFound: { ru: 'Проект не найден', en: 'Project not found', uk: 'Проект не знайдено' },
  completion: { ru: 'Выполнение', en: 'Completion', uk: 'Виконання' },
  history: { ru: 'История', en: 'History', uk: 'Історія' },
  tasksByAssignee: { ru: 'Задачи по исполнителям', en: 'Tasks by assignee', uk: 'Завдання за виконавцями' },
  activityTimeline: { ru: 'Динамика', en: 'Timeline', uk: 'Динаміка' },
  unassigned: { ru: 'Без исполнителя', en: 'Unassigned', uk: 'Без виконавця' },
  created: { ru: 'Создано', en: 'Created', uk: 'Створено' },
  noHistory: { ru: 'Нет изменений', en: 'No history', uk: 'Немає змін' },
  changedStatus: { ru: 'изменил(а) статус', en: 'changed status', uk: 'змінив(ла) статус' },
  createdProject: { ru: 'создал(а) проект', en: 'created project', uk: 'створив(ла) проект' },
  updatedField: { ru: 'обновил(а) поле', en: 'updated field', uk: 'оновив(ла) поле' },
