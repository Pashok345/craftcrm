...
import { Clock, Calendar, Users, Trash2, User } from 'lucide-react';
        ...
        <div className="space-y-4">
          ...
          {meeting.description && (
            <div className="space-y-1.5">
              <h4 className="text-sm font-medium text-foreground">Описание</h4>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Это действие нельзя отменить. Встреча будет удалена навсегда.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
