  ...
  return (
    <>
      ...
      <Button
        ...
        size="icon"
        className="fixed bottom-6 right-24 z-40 h-14 w-14 rounded-full shadow-lg hover:scale-105 transition-transform bg-gradient-to-br from-primary to-primary/80"
